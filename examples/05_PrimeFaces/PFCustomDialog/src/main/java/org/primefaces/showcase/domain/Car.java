...
public class Car implements Serializable {
  ...
  public Car(int id, int year, String manufacturer, String color) {
    this.id = id;
    this.year = year;
    this.manufacturer = manufacturer;
    this.brand = manufacturer;
  ...
  public Car(int id, String manufacturer, int year, String color, int price, boolean sold) {
    this("", year, manufacturer, color);
    this.price = price;
    this.sold = sold;
    this.id = id;
  }
