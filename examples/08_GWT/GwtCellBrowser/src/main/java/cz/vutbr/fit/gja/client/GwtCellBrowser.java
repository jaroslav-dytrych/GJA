/*
 * Adapted from http://www.tutorialspoint.com/gwt/gwt_cellbrowser_widget.htm
 */
...
public class GwtCellBrowser implements EntryPoint {
  /**
   * A list of songs.
   */
  ...
  private static class CustomTreeModel implements TreeViewModel {
    ...
    public <T> NodeInfo<?> getNodeInfo(T value) {
      if (value == null) {
        ...
        ListDataProvider<Playlist> dataProvider = new ListDataProvider<Playlist>(((Composer) value).getPlaylists());
  ...
  public void onModuleLoad() {
     ...
     */
    CellBrowser.Builder<TreeViewModel> builder = new CellBrowser.Builder<TreeViewModel>(model, null);
    CellBrowser browser = builder.build();
