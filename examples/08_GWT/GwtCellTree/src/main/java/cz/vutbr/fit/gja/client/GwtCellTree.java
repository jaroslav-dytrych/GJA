/*
 * Adapted from http://www.tutorialspoint.com/gwt/gwt_celltree_widget.htm
 */
...
public class GwtCellTree implements EntryPoint {
  /**
   * A list of songs.
   */
  ...
  private static class CustomTreeModel implements TreeViewModel {
    ...
    public <T> NodeInfo<?> getNodeInfo(T value) {
      if (value == null) {
        ...
        ListDataProvider<Composer> dataProvider = new ListDataProvider<GwtCellTree.Composer>(composers);
        // Create a cell to display a composer.
        Cell<GwtCellTree.Composer> cell = new AbstractCell<GwtCellTree.Composer>() {
        ...
        ListDataProvider<GwtCellTree.Playlist> dataProvider = new ListDataProvider<GwtCellTree.Playlist>(
            ((Composer) value).getPlaylists());
        Cell<GwtCellTree.Playlist> cell = new AbstractCell<GwtCellTree.Playlist>() {
